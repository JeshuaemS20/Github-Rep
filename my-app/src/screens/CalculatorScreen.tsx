...
export default function CalculatorScreen({ navigation }: Props) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.aiBottomBarWrapper}>
        <TextInput
          style={styles.textBarBottom}
          value={input}
          onChangeText={setInput}
          placeholder="Ask StudyCalc AI..."
          placeholderTextColor="#969b9e"
          returnKeyType="send"
          onSubmitEditing={handleAIConnect}
        ...
        <Pressable
          ...
          disabled={!input.trim()}
        >
          <Text style={styles.aiButtonTextBottom}>Ask AI</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
